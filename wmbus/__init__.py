...
# Hardware
# Joy-it NodeMCU-ESP32 - SX126x pin configuration
PIN_WMBUS_RESET = 12  # LORA RESET
PIN_WMBUS_DIO_1 = 14  # LORA DIO_1
PIN_WMBUS_BUSY  = 13  # LORA SPI BUSY
PIN_WMBUS_CS    =  8  # LORA SPI CS
PIN_WMBUS_SCLK  = 18  # LORA SPI CLK
PIN_WMBUS_MISO  = 19  # LORA SPI MISO
PIN_WMBUS_MOSI  = 23  # LORA SPI MOSI
